...
func _add_furniture():
	...
	body_bag_mat.albedo_color = Color(0.3, 0.3, 0.35)
	body_bag_mat.roughness = 0.9
	_make_decoration(Vector3(-1, 0.58, 11.5), Vector3(0.4, 0.15, 1.5), body_bag_mat)
