extends Control
## MainMenu - Horror themed main menu with dark atmosphere
## Animated title, blood drip effects, eerie background
...
var blood_drip_particles: GPUParticles2D


func _ready():
	# Create the horror themed UI
	_create_ui()
...
func _create_ui():
	## Create horror themed UI from code
	...
	# AI Ghost button (highlighted - main play mode)
	...
	ai_btn_style.border_width_bottom = 3
	ai_btn_style.border_width_top = 3
	ai_btn_style.border_width_left = 3
	ai_btn_style.border_width_right = 3
	...
	host_button.add_theme_color_override("font_hover_color", Color(1.0, 0.8, 0.8))
	...
	join_button.add_theme_color_override("font_hover_color", Color(1.0, 0.8, 0.8))
	...
	settings_button.add_theme_color_override("font_hover_color", Color(0.8, 0.7, 0.7))
	...
	quit_button.add_theme_color_override("font_hover_color", Color(0.7, 0.6, 0.6))
	...
	join_panel_style.border_color = Color(0.4, 0.1, 0.1)
	join_panel_style.border_width_bottom = 2
	join_panel_style.border_width_top = 2
	join_panel_style.border_width_left = 2
	join_panel_style.border_width_right = 2
	...
	ip_label.add_theme_color_override("font_color", Color(0.7, 0.6, 0.6))
	join_vbox.add_child(ip_label)
	...
	name_label.add_theme_color_override("font_color", Color(0.7, 0.6, 0.6))
	join_vbox.add_child(name_label)
	...
	host_panel_style.border_color = Color(0.4, 0.1, 0.1)
	host_panel_style.border_width_bottom = 2
	host_panel_style.border_width_top = 2
	host_panel_style.border_width_left = 2
	host_panel_style.border_width_right = 2
	...
	var host_name_label = Label.new()
	host_name_label.text = "Host Name:"
	host_name_label.add_theme_color_override("font_color", Color(0.7, 0.6, 0.6))
	host_vbox.add_child(host_name_label)
	...
	players_label.add_theme_color_override("font_color", Color(0.7, 0.6, 0.6))
	host_vbox.add_child(players_label)
...
func _process(delta):
	# Animate title (pulsing red glow)
